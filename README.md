...
The packages in the `xacro` repository were released into the `jazzy` distro by running `/home/z572/gits/rockos-ros/venv/bin/bloom-release -r jazzy xacro --override-release-repository-push-url git@github.com:rockos-riscv-ros/xacro-release.git` on `Fri, 21 Mar 2025 07:23:55 -0000`
...
- release repository: https://github.com/rockos-riscv-ros/xacro-release.git
